...
const HEADING_ID = "construcao-lsf-process-steps-heading";
...
const STEPS: readonly Step[] = [
  ...
  },
  {
    ...
    description:
      "Orçamento discriminado, cronograma e cálculo da estrutura.",
  },
  {
    number: "3",
    title: "Execução acompanhada",
    description:
      "Montagem com relatório de progresso e acesso direto ao responsável de obra.",
  },
  {
    number: "4",
    title: "Entrega",
...
export function ConstrucaoLsfProcessSteps() {
  return (
    <section
      ...
      >
        ...
        <div className="mt-12 flex justify-center lg:mt-16">
          <WebsiteQuoteDialog
            ...
            title="Pedido de orçamento — Construção em LSF"
            trigger={
              <Button
