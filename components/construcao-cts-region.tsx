...
const HEADING_ID = "construcao-cts-region-heading";
...
export function ConstrucaoCtsRegion() {
  return (
    <section aria-labelledby={HEADING_ID} className="w-full">
      ...
      >
        ...
        <h2
          ...
          id={HEADING_ID}
        >
          Construção sustentável na região
        </h2>
        <p className="mt-6 max-w-4xl text-pretty text-base leading-relaxed text-muted-foreground md:mt-8 md:text-lg">
          Executamos obras em alvenaria sustentável no Distrito de Coimbra, com
          o rigor de quem domina a construção e a reabilitação. Procura uma
          moradia, ampliação ou reabilitação com materiais e práticas orientadas
