...
const HEADING_ID = "construcao-cts-process-steps-heading";
...
const STEPS: readonly Step[] = [
  ...
  },
  {
    ...
    description:
      "Orçamento discriminado, cronograma e definição das soluções construtivas.",
  },
  {
    number: "3",
    title: "Execução acompanhada",
    description:
      "Obra com relatório de progresso e acesso direto ao responsável de obra.",
  },
  {
    number: "4",
    title: "Entrega",
...
export function ConstrucaoCtsProcessSteps() {
  return (
    <section
      ...
      >
        ...
        <div className="mt-12 flex justify-center lg:mt-16">
          <WebsiteQuoteDialog
            ...
            title="Pedido de orçamento — Construção Alvenaria Sustentável"
            trigger={
              <Button
