...
const HEADING_ID = "construcao-cts-showcase-heading";

/** Interior metal stud / framing — residential-scale CTS context (Unsplash). */
const SHOWCASE_LEFT_SRC =
  "https://images.unsplash.com/photo-1768321911446-baeb6c1a673f?w=1200&q=80";

const SHOWCASE_LEFT_ALT =
  "Vista interior de um edifício em construção com estrutura de construção tradicional sustentável, ilustrativa de construção em contexto residencial.";
...
export function ConstrucaoCtsDualShowcase() {
  return (
    <section
    ...
    >
      ...
      >
        <h2 className="sr-only" id={HEADING_ID}>
          Exemplos visuais de estruturas de construção tradicional sustentável em obra
        </h2>
