...
const HEADING_ID = "construcao-lsf-region-heading";
...
export function ConstrucaoLsfRegion() {
  return (
    <section aria-labelledby={HEADING_ID} className="w-full">
      ...
      >
        ...
        <h2
          ...
          id={HEADING_ID}
        >
          Pioneiros do LSF na região
        </h2>
        <p className="mt-6 max-w-4xl text-pretty text-base leading-relaxed text-muted-foreground md:mt-8 md:text-lg">
          O LSF ainda é pouco comum no Centro de Portugal. A SublimePT está a
          trazê-lo ao Distrito de Coimbra, com formação certificada e o rigor de
          quem domina a construção e a reabilitação. Procura uma casa,
          ampliação ou reabilitação em LSF?{" "}
          <a
